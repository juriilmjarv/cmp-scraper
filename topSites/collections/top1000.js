...
const list = top1000.map(e => 'https://' + e.DataUrl);
fs.writeFile('/Users/juriilmjarv/Desktop/UniStuff/Dark Patterns/New/puppeteer_scraping/esm-modules/topSites/finalData/top1000.js', JSON.stringify(list, null, 2), function(err) {
    if(err) {
